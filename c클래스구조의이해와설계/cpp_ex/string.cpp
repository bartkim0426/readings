...
friend ostream& operator << (ostream & OS,const String &S);// out stream displays the string
friend istream& operator >> (istream & IS,String &S);//instream takes in a string and creates and object
